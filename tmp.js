...
<!-- End Google Tag Manager (noscript) -->
    ...
    <div class="memus_div">
    <a class="memus" id="home_link" href="./index.html">&thinsp;ホーム&thinsp; </a>
    <a class="memus" id="content_link" href="./content.html">&thinsp; 活動内容&thinsp; </a>
    <!--<a class="memus" id="chemistry_link" href="./chemistry.html">化学実験&thinsp; </a>-->
    <a class="memus" id="records_link" href="./recoed.html">&thinsp;活動実績&thinsp;</a>
    <a class="memus" id="enter_link" href="./enter.html">&thinsp; 入部案内&thinsp; 
    </a>
    </div>
    </div>
    </header> `
...
function tmp_under() {
    ...
    <footer>
    <div id="rap_under_bar"><div class="under_bar" id="under_bar">
    <div class="under_bar" id="index_underbar">
    <table>
    <tr>
